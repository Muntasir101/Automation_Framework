...
def test_case4_logout(setup):
    ...
    # 1. open home page
    test_log_instance.logger.info("....Start: test_case4_logout.............")
    ...
    base_page.take_screenshot(FileConfig.SCREENSHOT_FILE_LOCATION_TESTCASE4 + "\\verify_login_page.png")
    ...
    base_page.take_screenshot(FileConfig.SCREENSHOT_FILE_LOCATION_TESTCASE4 + "\\verify_logged.png")

    # 9. Click 'Logout' button
    home_page.click_logout()
    base_page.take_screenshot(FileConfig.SCREENSHOT_FILE_LOCATION_TESTCASE4 + "\\logout.png")

    # 10. Verify that user is navigated to login page
    assert base_page.get_page_title(), "Automation Exercise - Signup / Login"

    test_log_instance.logger.info("All steps complete successfully......")
    test_log_instance.logger.info("..........End: test_case4_logout.............")
